        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-8">
              ...
              <a href="https://wa.me/5567991100706" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:border-aurea-gold hover:text-aurea-gold transition-all">
