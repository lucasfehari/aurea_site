    ...
    <div className="w-full pt-32 pb-20">
      ...
      <section className="px-6 md:px-12 max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
          ...
          <div className="bg-aurea-surface p-10 md:p-16 rounded-[3rem] border border-white/5 h-full flex flex-col">
            ...
            <div className="space-y-8 flex-grow">
              ...
              <div className="space-y-4">
                <a href="https://wa.me/5567991010303?text=Ol%C3%A1%2C%20vim%20pelo%20site%20%C3%81urea." target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-aurea-light/80 hover:text-aurea-gold transition-colors font-sans">
          ...
          {/* Atendimento VIP */}
          <div className="bg-aurea-surface p-10 md:p-16 rounded-[3rem] border border-aurea-gold/20 h-full flex flex-col items-center justify-center text-center">
            <h2 className="font-serif text-3xl text-aurea-gold mb-6">Atendimento VIP</h2>
            <p className="font-sans text-aurea-light/80 mb-10 max-w-sm leading-relaxed">
              Inicie um atendimento exclusivo através do nosso WhatsApp. Nossa equipe está pronta para apresentar as melhores oportunidades e soluções sob medida para você.
            </p>
            <a 
              href="https://wa.me/5567991010303?text=Ol%C3%A1%2C%20vim%20pelo%20site%20%C3%81urea."
              target="_blank" 
              rel="noopener noreferrer" 
              className="flex items-center justify-center gap-3 bg-aurea-gold text-aurea-dark px-8 py-4 rounded-full font-sans font-medium uppercase tracking-widest text-sm hover:bg-aurea-light transition-colors"
            >
