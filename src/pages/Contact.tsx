...
export const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const phoneNumber = "5567991010303";
          ...
          <div className="bg-aurea-surface p-10 md:p-16 rounded-[3rem] border border-white/5 h-full flex flex-col">
            ...
            <div className="space-y-8 flex-grow">
              ...
              <div className="space-y-4">
                <a href="https://wa.me/5567991010303" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-aurea-light/80 hover:text-aurea-gold transition-colors font-sans">
